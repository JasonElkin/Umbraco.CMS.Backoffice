...
export class UmbWorkspaceViewDataTypeInfoElement extends UmbLitElement {
	...
	constructor() {
		...
		this.consumeContext<UmbWorkspaceRelationTypeContext>('umbWorkspaceContext', (dataTypeContext) => {
...
declare global {
	interface HTMLElementTagNameMap {
		'umb-workspace-view-relation-type-info': UmbWorkspaceViewDataTypeInfoElement;
	}
}
