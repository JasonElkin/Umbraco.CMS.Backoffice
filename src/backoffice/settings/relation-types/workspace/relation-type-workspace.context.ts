...
import { UMB_DATA_TYPE_DETAIL_STORE_CONTEXT_TOKEN } from '../../data-types/data-type.detail.store';
import type { DataTypeDetails } from '@umbraco-cms/models';
import { appendToFrozenArray } from '@umbraco-cms/observable-api';

export class UmbWorkspaceRelationTypeContext
	extends UmbWorkspaceContext
	implements UmbWorkspaceEntityContextInterface<DataTypeDetails | undefined>
{
