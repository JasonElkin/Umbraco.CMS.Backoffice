...
export class UmbRelationTypeTreeRepository implements UmbTreeRepository {
	#host: UmbControllerHostInterface;
	#dataSource: RelationTypeTreeServerDataSource;
	...
	constructor(host: UmbControllerHostInterface) {
		...
		this.#dataSource = new RelationTypeTreeServerDataSource(this.#host);
