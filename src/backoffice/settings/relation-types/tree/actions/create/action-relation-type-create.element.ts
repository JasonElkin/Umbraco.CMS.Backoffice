...
@customElement('umb-tree-action-relation-type-create')
export default class UmbTreeActionRelationTypeCreateElement extends UmbTreeItemActionElement {
...
declare global {
	interface HTMLElementTagNameMap {
		'umb-tree-action-relation-type-create': UmbTreeActionRelationTypeCreateElement;
	}
}
