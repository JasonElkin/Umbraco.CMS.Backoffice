...
@customElement('umb-create-relation-type-tree-action')
export default class UmbCreateRelationTypeTreeAction extends UmbTreeItemActionElement {
...
declare global {
	interface HTMLElementTagNameMap {
		'umb-create-relation-type-tree-action': UmbCreateRelationTypeTreeAction;
	}
}
